...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_ClusterState_To_clusterregistry_ClusterState,
		Convert_clusterregistry_ClusterState_To_v1alpha1_ClusterState,
		Convert_v1alpha1_KubeAPIServer_To_clusterregistry_KubeAPIServer,
		Convert_clusterregistry_KubeAPIServer_To_v1alpha1_KubeAPIServer,
	)
}
...
func autoConvert_v1alpha1_AuthInfo_To_clusterregistry_AuthInfo(in *AuthInfo, out *clusterregistry.AuthInfo, s conversion.Scope) error {
	out.AuthProviders = *(*[]clusterregistry.AuthProviderConfig)(unsafe.Pointer(&in.AuthProviders))
	return nil
}
...
func autoConvert_clusterregistry_AuthInfo_To_v1alpha1_AuthInfo(in *clusterregistry.AuthInfo, out *AuthInfo, s conversion.Scope) error {
	out.AuthProviders = *(*[]AuthProviderConfig)(unsafe.Pointer(&in.AuthProviders))
	return nil
}
...
func autoConvert_v1alpha1_Cluster_To_clusterregistry_Cluster(in *Cluster, out *clusterregistry.Cluster, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ClusterState_To_clusterregistry_ClusterState(&in.State, &out.State, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_clusterregistry_Cluster_To_v1alpha1_Cluster(in *clusterregistry.Cluster, out *Cluster, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_clusterregistry_ClusterState_To_v1alpha1_ClusterState(&in.State, &out.State, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_ClusterState_To_clusterregistry_ClusterState(in *ClusterState, out *clusterregistry.ClusterState, s conversion.Scope) error {
	if err := Convert_v1alpha1_KubeAPIServer_To_clusterregistry_KubeAPIServer(&in.KubeAPIServer, &out.KubeAPIServer, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_AuthInfo_To_clusterregistry_AuthInfo(&in.AuthInfo, &out.AuthInfo, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_CloudProvider_To_clusterregistry_CloudProvider(&in.CloudProvider, &out.CloudProvider, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1alpha1_ClusterState_To_clusterregistry_ClusterState is an autogenerated conversion function.
func Convert_v1alpha1_ClusterState_To_clusterregistry_ClusterState(in *ClusterState, out *clusterregistry.ClusterState, s conversion.Scope) error {
	return autoConvert_v1alpha1_ClusterState_To_clusterregistry_ClusterState(in, out, s)
}

func autoConvert_clusterregistry_ClusterState_To_v1alpha1_ClusterState(in *clusterregistry.ClusterState, out *ClusterState, s conversion.Scope) error {
	if err := Convert_clusterregistry_KubeAPIServer_To_v1alpha1_KubeAPIServer(&in.KubeAPIServer, &out.KubeAPIServer, s); err != nil {
		return err
	}
	if err := Convert_clusterregistry_AuthInfo_To_v1alpha1_AuthInfo(&in.AuthInfo, &out.AuthInfo, s); err != nil {
		return err
	}
	if err := Convert_clusterregistry_CloudProvider_To_v1alpha1_CloudProvider(&in.CloudProvider, &out.CloudProvider, s); err != nil {
		return err
	}
	return nil
}

// Convert_clusterregistry_ClusterState_To_v1alpha1_ClusterState is an autogenerated conversion function.
func Convert_clusterregistry_ClusterState_To_v1alpha1_ClusterState(in *clusterregistry.ClusterState, out *ClusterState, s conversion.Scope) error {
	return autoConvert_clusterregistry_ClusterState_To_v1alpha1_ClusterState(in, out, s)
}

func autoConvert_v1alpha1_KubeAPIServer_To_clusterregistry_KubeAPIServer(in *KubeAPIServer, out *clusterregistry.KubeAPIServer, s conversion.Scope) error {
	out.Servers = *(*[]clusterregistry.URL)(unsafe.Pointer(&in.Servers))
	out.CABundle = *(*[]byte)(unsafe.Pointer(&in.CABundle))
	return nil
}

// Convert_v1alpha1_KubeAPIServer_To_clusterregistry_KubeAPIServer is an autogenerated conversion function.
func Convert_v1alpha1_KubeAPIServer_To_clusterregistry_KubeAPIServer(in *KubeAPIServer, out *clusterregistry.KubeAPIServer, s conversion.Scope) error {
	return autoConvert_v1alpha1_KubeAPIServer_To_clusterregistry_KubeAPIServer(in, out, s)
}

func autoConvert_clusterregistry_KubeAPIServer_To_v1alpha1_KubeAPIServer(in *clusterregistry.KubeAPIServer, out *KubeAPIServer, s conversion.Scope) error {
	out.Servers = *(*[]URL)(unsafe.Pointer(&in.Servers))
	out.CABundle = *(*[]byte)(unsafe.Pointer(&in.CABundle))
	return nil
}

// Convert_clusterregistry_KubeAPIServer_To_v1alpha1_KubeAPIServer is an autogenerated conversion function.
func Convert_clusterregistry_KubeAPIServer_To_v1alpha1_KubeAPIServer(in *clusterregistry.KubeAPIServer, out *KubeAPIServer, s conversion.Scope) error {
	return autoConvert_clusterregistry_KubeAPIServer_To_v1alpha1_KubeAPIServer(in, out, s)
}
